...
-- Define names for the outputs from the datapath.
      ...
      (ma,md,cond,a,b,ir,pc,ad,ovfl,r,x,y,p,mul_ready) = datapath_outputs -- for task 2, mul_ready is added to the datapath
...
-- converting them to readable form.
      ...
      simoutput =
        [
         ...
         string "\n  ",
         string "      cm_mul0 = ", bit (cm_mul0 ctlstate),
         ...
         string "    cm_loadxi0 = ", bit (cm_loadxi0 ctlstate),
         string "    cm_loadxi1 = ", bit (cm_loadxi1 ctlstate),
         string "    cm_loadxi2  = ", bit (cm_loadxi2 ctlstate),
         string "\n  ",
         string "    cm_loadxi3 = ", bit (cm_loadxi3 ctlstate),
         ...
         string "\n\nControl signals\n  ",
           ...
           string "  ctl_rf_increment  = ", bit (ctl_rf_increment ctlsigs), -- for task 1, the ctl signal is added here to be printed
